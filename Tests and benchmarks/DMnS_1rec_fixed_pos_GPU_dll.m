function img = DMnS_1rec_fixed_pos_GPU_dll(rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,CUDAparams)
% USAGE: 
% 
%   img = DMnS_1rec_fixed_pos_GPU_dll(rf_data,source_locations,receiver_location,image_coordinates,c,fsamp,CUDAparams)
% 
% INPUTS:
...
[~,~,~,~,~,img] = calllib('IntDevImgAlgGPU','DMnS_1rec_fixed_pos_GPU_chunks_interface',...
